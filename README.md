...
* 我在此项目负责作为项目中间件的PHP API以及其对应的[后台管理系统](http://gitlab.baidu.com/linxingchen/csiem_admin)的开发。  
* 无需培训即可根据需求迅速地高质量完成任务，并加深自学PHPDOC、PHPUnit、Redis、ElasticSearch、设计模式、敏捷项目开发等技术知识。
...
* 2014.03 - 今 [三位一体信息化社团建设套件第二版](https://github.com/SUTFutureCoder/nws_v2)（**开发进行中**） 
